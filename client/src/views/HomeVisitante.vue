...
<nav class="flex items-center justify-between">
                <h2 class="text-gray-200 font-bold text-2xl m-8 ">Home</h2>
                <div class="auth flex items-center">
                    <button  @click="login" class="m-8 bg-transparent text-gray-200  p-2 rounded border border-gray-300 mr-4 hover:bg-gray-100 hover:text-gray-700">Iniciar Sesion</button>
                    <button  @click="register" class=" m-8 bg-gray-900 text-gray-200  py-2 px-3 rounded  hover:bg-gray-800 hover:text-gray-100">Registrarse Gratis</button>
                </div>
            </nav>

  <div class="container max-w-5xl mx-auto px-4">
    <div class="w-4/5">
      <h1 class="mt-32 text-white text-6xl font-bold">Bienvenido al Kiosko Ventur<br/><span class="text-blue-400">Su kiosko de confianza</span></h1>
    </div>
    ...
    <div class="text-white relative">
      ...
      <div class="grid sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-1 sm:gap-5 uppercase">
        <div class="h-72 group flex items-center bg-indigo-900 bg-opacity-40 shadow-xl gap-5 px-6 py-5 rounded-lg ring-2 ring-offset-2 ring-offset-blue-800 ring-cyan-700 mt-5 cursor-pointer hover:bg-blue-900 hover:bg-opacity-100 transition">
