  ...
  <div class="flex bg-gray-300 dark:bg-gray-900">
    ...
    <div class="w-full">
      <div class="min-h-screen bg-gray-300 dark:bg-gray-900 py-6 flex flex-col text-center sm:py-s">
        ...
        <span style="font-size: 60%" class="block w-full py-2 text-transparent bg-clip-text leading-12 bg-gradient-to-r from-green-400 to-purple-500 lg:inline">Cartas Pokemon: {{ cartas2 }}/10 ({{ estateCollection2 }}) </span><br />
        </h1>
        <div class="ml-10 grid lg:grid-cols-5 gap-5">
          <div v-for="selected in cartasUserPokemon" :key="selected">
            ...
            />
                ...
                <h1 class="mb-8 text-4xl font-extrabold leading-none tracking-normal text-gray-900 md:text-6xl md:tracking-tight">
              <div class="min-h-screen bg-gray-300 dark:bg-gray-900 py-6 flex flex-col text-center sm:py-s">
                     <span style="font-size: 60%" class="block w-full py-2 text-transparent bg-clip-text leading-12 bg-gradient-to-r from-green-400 to-purple-500 lg:inline">Cartas Coches: {{ cartas1 }}/10 ({{ estateCollection1 }})</span>
 <div class="ml-10 grid lg:grid-cols-5 gap-5">
