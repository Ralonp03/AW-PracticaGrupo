    ...
    <div class="flex">
      ...
      <div class="w-full">
          ...
          >
            ...
            <span
              ...
              class="
                ...
                lg:inline
              "
              >Cartas Pokemon: {{ cartas1 }}/10 ({{ estateCollection1 }}) </span
            ><br />
            <span
              style="font-size: 60%"
              class="
                ...
                lg:inline
              "
              >Cartas Coches: {{ cartas2 }}/10 ({{ estateCollection2 }})</span
            >
          </h1>
        </div>
        <div
        ...
        >
          ...
          >
            <div
              class="p-4 grid gap-4 grid-flow-col auto-cols-max border-gray-800"
              v-for="selected in cartasUser"
              :key="selected"
            >
              <img
